...
W_box1<-subset(c_prep4,select=c(1:2,24:40))%>%
...
#reshape for box plots
SE_box1<-subset(c_prep4,select=c(1:2,24:40))%>%
...
#reshape for box plots
OV_box1<-subset(c_prep4,select=c(1:2,24:40))%>%
...
#reshape for box plots
NW_box1<-subset(c_prep4,select=c(1:2,24:40))%>%
...
c_prep5<-left_join(c_prep4,health_c, by="cofips")
c_prep5<-subset(c_prep5,select=-c(41:42))

#START TO MAP VARIABLES IN LISA
