...
sts<- st_boundary(sts)%>%
  ...
  filter(!STATEFP%in%c('02','15','60','66','69','72','78')) #exclude those outside of continental US
...
acs_dat <-acs %>%
  ...
  rename(cofips = GEOID)
  #ADD A FILTER HERE BASED ON LAT TO EXCLUDE AK/HI
...
AAMR_ICDI_all <- read.table('C:/Users/tamas/OneDrive/Documents/APDEM 808/data files/ICD I00 I99 Mortality Rates Age Adjusted All Age-2014 thru 2016.txt',header = TRUE, sep = "\t", fill=TRUE)
AAMR_ICDI_65 <- read.table('C:/Users/tamas/OneDrive/Documents/APDEM 808/data files/ICD I00 I99 Mortality Rates Age Adjusted 65+ 2014 thru 2016.txt',header = TRUE, sep = "\t", fill=TRUE)
...
prep1%>%
  ...
  ggtitle("Age-Adjusted Mortality Rate", subtitle = "ACE 5-year estimates, 2016 - 2020")
...
prep1%>%
  ...
  geom_sf(data=sts, color="black")+
  ggtitle("Age-Adjusted Mortality Rates - ICD XX to XX", subtitle = "ACE 5-year estimates, 2016 - 2020")
...
prep1%>%
  ...
  geom_sf(data=sts, color="black")+
  ggtitle("Age-Adjusted Mortality Rates 65+: ICD XX to XX", subtitle = "ACE 5-year estimates, 2016 - 2020")
...
This research uses U.S. age-adjusted mortality rates from respiratory diseases (defined as ICD-10 codes J00 - J99) as the respiratory health indicator. In Mueller and colleagues' literature analysis on greenspace and respiratory health research, they found that respiratory mortality had the most consistent positive evidence as compared to research measuring other health indicators, including asthma, lung function, hospital admissions, among other measures [@mueller2022, pp. 28]. USING THIS MEASUREMENT VARIABLE WILL DO SOMETHING.

## Data and Methods
>>>>>>> 713095ed37ca9ae8e22409974c799b9b43242df8
