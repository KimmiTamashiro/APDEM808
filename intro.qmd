...
Calculating the entropy index: Let $$p_j$$ be the percentage each of land use type j in the county, and let n be the number of land use types j.
...
c_prep6%>%
  ...
  scale_colour_viridis_d()+
  scale_fill_viridis_d(option = "cividis",direction = -1, na.value="grey50")+
  scale_y_continuous(label=scales::comma)+
  geom_sf(data=sts, color="black")+
